...
; The PhC slab is composed of silica holes with triangular lattice in silicon.                               
; The PhC waveguide is formed by removing one row of silica holes (W1.00). It is cladded with silica.                                  
...
(define eps2 (expt 1.44 2)) ; epsilon of silica (SiO2) at 1550 nm
...
; Step 4.1: Set background material as SiO2.
